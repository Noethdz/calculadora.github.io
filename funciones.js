...
var index = 0;
var listaimg = ["https://img.icons8.com/ios-filled/50/github.png", "https://img.icons8.com/nolan/64/linkedin.png", ""];
var listaruta = ["https://github.com/Noethdz", "http://www.linkedin.com/in/noe-trejo", ""];

function changeImage() {
    document.getElementById('icon').setAttribute("src", listaimg[index]);
    document.getElementById('ruta').setAttribute("href", listaruta[index]);
